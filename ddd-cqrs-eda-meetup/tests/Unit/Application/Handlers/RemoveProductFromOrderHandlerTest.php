...
use App\Application\Handlers\{AddProductToOrderHandler, RemoveProductFromOrderHandler};
use App\Domain\{AbstractOrderRepository, AbstractProductRepository, Order, Product, ProductRemovedFromOrder};
...
class RemoveProductFromOrderHandlerTest extends BaseTestCase
{
    ...
    private RemoveProductFromOrderHandler $sut;
    ...
    protected function setUp(): void
    {
        ...
        $this->sut = new RemoveProductFromOrderHandler(
            $this->validator,
    ...
    {
        $command = new RemoveProductFromOrderCommand('123', '123');
